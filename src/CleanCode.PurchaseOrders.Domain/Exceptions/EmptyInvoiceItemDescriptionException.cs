...
{
    public EmptyInvoiceItemDescriptionException(InvoiceItem invoiceItem) : base($"Order Item Description cannot be empty for supplied Invoice : {invoiceItem.Description}")
    {
    }
}